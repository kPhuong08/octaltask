...
export function UserMenu({ user, onLogout }: UserMenuProps) {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <div
        className={cn(
          'absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 z-50 overflow-hidden transition-all duration-150 transform origin-top-right',
          isOpen
