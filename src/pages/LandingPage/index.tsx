    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-sm border-b border-gray-200 dark:bg-gray-800/90 dark:border-gray-700">
                <div className="px-4 py-2.5 flex justify-between items-center max-w-7xl mx-auto">
                    ...
                    <nav className="hidden md:flex items-center gap-6">
                        <a href="#features" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Features</a>
                        <a href="#testimonials" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Testimonials</a>
                        <a href="#pricing" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">Pricing</a>
                        <a href="#faq" className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 font-medium">FAQ</a>
                    </nav>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="text-center md:text-left">
                                ...
                                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6 tracking-tight">
                                    Manage tasks efficiently with <span className="text-blue-600 dark:text-blue-400">OctalTask</span>
                                </h1>
                                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto md:mx-0 mb-8">
                                    Simplify task management, boost productivity, and collaborate seamlessly with your team. The all-in-one solution for personal and team productivity.
                                </p>
                            ...
                            <div className="hidden md:block relative">
                                ...
                                <div className="relative shadow-2xl rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden transform rotate-1 hover:rotate-0 transition-transform duration-300">
                                    <img
                                        ...
                                        onError={(e) => {
                                            e.currentTarget.src = "https://placehold.co/600x400/4f46e5/white?text=OctalTask+Dashboard";
                                        }}
                                    />
                                </div>
                            </div>
                ...
                <section id="about" className="py-20 bg-white dark:bg-gray-800 px-4">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16 animate-on-scroll">
                            ...
                            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                                A collaborative web development project created at the University of Information Technology - VNUHCM
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
                            <div className="animate-on-scroll" style={{ transitionDelay: '100ms' }}>
                                <div className="bg-gradient-to-br from-blue-500 to-purple-600 p-1 rounded-2xl shadow-xl">
                                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl">
                                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Project Overview</h3>
                                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                                            OctalTask is a comprehensive task management web application developed as a group project for our Web Development course at the University of Information Technology - Vietnam National University, Ho Chi Minh City.
                                        </p>
                                        <p className="text-gray-600 dark:text-gray-300 mb-4">
                                            Our goal was to create a modern, user-friendly application that allows individuals and teams to efficiently organize tasks, collaborate in real-time, and boost productivity through intuitive design and powerful features.
                                        </p>
                                        <div className="text-gray-600 dark:text-gray-300">
                                            <p className="font-medium text-blue-600 dark:text-blue-400">Technologies used:</p>
                                            <div className="flex flex-wrap gap-2 mt-2">
                            ...
                            <div className="animate-on-scroll" style={{ transitionDelay: '300ms' }}>
                                <img
                                    ...
                                    className="rounded-xl shadow-xl w-full h-auto object-cover"
                                    onError={(e) => {
                                        e.currentTarget.src = "https://placehold.co/800x600/4f46e5/white?text=OctalTask+Screenshot";
                                    }}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                            {/* Team Member 1 */}
                            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:scale-105 animate-on-scroll" style={{ transitionDelay: '100ms' }}>
                                <div className="aspect-square bg-gradient-to-tr from-blue-400 to-purple-500 relative overflow-hidden">
                                    <img
                                        src="/team-member1.jpg"
                                        alt="Team Member"
                                        className="w-full h-full object-cover opacity-90"
                                        onError={(e) => {
                                            e.currentTarget.src = "https://placehold.co/400x400/4f46e5/white?text=Team+Member";
                                        }}
                                    />
                                </div>
                                <div className="p-6">
                                    <h4 className="text-xl font-bold text-gray-900 dark:text-white">Team Member Name</h4>
                                    <p className="text-blue-600 dark:text-blue-400 mb-2">Role / Student ID</p>
                                    <p className="text-gray-600 dark:text-gray-300 text-sm mb-4">
                                        Short description or responsibility in the project.
                                    </p>
                                    <div className="flex gap-3">
                                        ...
                                        <a href="mailto:student@example.com" className="text-gray-600 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400">
                            ...
                            {/* Team Member 2 */}
                            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:scale-105 animate-on-scroll" style={{ transitionDelay: '200ms' }}>
                                <div className="aspect-square bg-gradient-to-tr from-green-400 to-blue-500 relative overflow-hidden">
                                    <img
                                        src="/team-member2.jpg"
                                        alt="Team Member"
                                        className="w-full h-full object-cover opacity-90"
                                        onError={(e) => {
                                            e.currentTarget.src = "https://placehold.co/400x400/22c55e/white?text=Team+Member";
                                        }}
                                    />
                                </div>
                                <div className="p-6">
                            ...
                            {/* Team Member 3 */}
                            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:scale-105 animate-on-scroll" style={{ transitionDelay: '300ms' }}>
                                <div className="aspect-square bg-gradient-to-tr from-purple-400 to-pink-500 relative overflow-hidden">
                                    <img
                                        src="/team-member3.jpg"
                                        alt="Team Member"
                                        className="w-full h-full object-cover opacity-90"
                                        onError={(e) => {
                                            e.currentTarget.src = "https://placehold.co/400x400/a855f7/white?text=Team+Member";
                                        }}
                                    />
                                </div>
                                <div className="p-6">
                            ...
                            {/* Team Member 4 */}
                            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl overflow-hidden shadow-md transition-transform duration-300 hover:scale-105 animate-on-scroll" style={{ transitionDelay: '400ms' }}>
                                <div className="aspect-square bg-gradient-to-tr from-orange-400 to-red-500 relative overflow-hidden">
                                    <img
                                        src="/team-member4.jpg"
                                        alt="Team Member"
                                        className="w-full h-full object-cover opacity-90"
                                        onError={(e) => {
                                            e.currentTarget.src = "https://placehold.co/400x400/f97316/white?text=Team+Member";
                                        }}
                                    />
                                </div>
                                <div className="p-6">
                ...
                <section id="testimonials" className="py-20 bg-white dark:bg-gray-800 px-4">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center mb-16 animate-on-scroll">
                            ...
                            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                                Join thousands of satisfied users who have transformed their productivity with OctalTask.
                            </p>
                        </div>

                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl shadow-sm animate-on-scroll" style={{ transitionDelay: '100ms' }}>
                                <div className="flex items-center mb-6">
                                    <div className="relative mr-4">
                                        <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
                                            J
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-4">
                                    "OctalTask completely transformed how our marketing team manages campaigns. The collaboration features are fantastic, and the interface is so intuitive. Can't imagine working without it now."
                                </p>
                            </div>

                            <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl shadow-sm animate-on-scroll" style={{ transitionDelay: '200ms' }}>
                                <div className="flex items-center mb-6">
                                    <div className="relative mr-4">
                                        <div className="w-12 h-12 bg-purple-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
                                            S
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-4">
                                    "As a freelancer juggling multiple clients, OctalTask keeps me organized and on schedule. The ability to create custom lists for each project is a game-changer for my workflow."
                                </p>
                            </div>

                            <div className="bg-gray-50 dark:bg-gray-700 p-8 rounded-xl shadow-sm animate-on-scroll" style={{ transitionDelay: '300ms' }}>
                                <div className="flex items-center mb-6">
                                    <div className="relative mr-4">
                                        <div className="w-12 h-12 bg-green-600 rounded-full flex items-center justify-center text-white text-xl font-bold">
                                            M
                                ...
                                <p className="text-gray-600 dark:text-gray-300 mb-4">
                                    "OctalTask has been instrumental in our product development process. The ability to share tasks with stakeholders and track progress has significantly improved our delivery timelines."
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4">
                            {[
                                {
                                    question: "How do I get started with OctalTask?",
                                    answer: "Getting started is easy! Simply sign up for a free account, create your first task list, and start adding tasks. Our intuitive interface makes it simple to organize and manage your tasks from day one."
                                },
                                {
                                    question: "Can I use OctalTask on my mobile device?",
                                    answer: "Yes! OctalTask is fully responsive and works on all devices including smartphones and tablets. Our web app adapts to any screen size for a seamless experience wherever you are."
                                },
                                {
                                    question: "How does task sharing and collaboration work?",
                                    answer: "You can share tasks or entire lists with team members by entering their email address and assigning permissions (viewer, editor, or admin). They'll receive an invitation and can immediately start collaborating with you."
                                },
                                {
                                    question: "Is my data secure with OctalTask?",
                                    answer: "Absolutely. We use industry-standard encryption to protect your data. All information is transmitted over secure HTTPS connections, and we regularly back up all data to prevent any loss."
                                }
                            ].map((faq, index) => (
                                <div
                                    key={index}
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <svg
                                            className={`w-5 h-5 text-gray-500 transition-transform ${visibleFAQ === index ? 'transform rotate-180' : ''}`}
                                            fill="none"
                                            viewBox="0 0 24 24"
                                            stroke="currentColor"
                                        >
                                    ...
                                    <div
                                        className={`transition-all duration-300 ease-in-out ${visibleFAQ === index ? 'max-h-96 p-5 border-t border-gray-200 dark:border-gray-700' : 'max-h-0 py-0 px-5 overflow-hidden'}`}
                                    >
                                        <p className="text-gray-600 dark:text-gray-300">{faq.answer}</p>
                                    </div>
                                </div>
            ...
            <style
                dangerouslySetInnerHTML={{
                    __html: `
>>>>>>> 241ebfa978494c50d98c3e1f637c6914ce2caac4
                        .animate-on-scroll {
                            opacity: 0;
